...
int malloc(int size){
    return asm_system_call(5, size);
}

void free_bite(void* ptr){
    asm_system_call(6, (int)ptr);
}

int* malloc_test(){
    int* a;
    a = (int* )sys_malloc(4*sizeof(int));
    for(int i = 0; i < 4; i++){
        *(a + i) = i;
    }
    return a;
...
void first_process()
{
    printf("This is in the first process.\n");
    int* b = (int*)malloc(520); 
    printf("malloc size of 520 at address %x.\n", b);
    free_bite(b);
    printf("free 520 successfully!\n");
    int* a = (int* )malloc(33);
    printf("malloc size of 33 at address %x.\n", a);
...
{
    printf("This is in the second thread.\n");
    ...
    printf("\nmalloc sizeof 4 integers at %x.\n", a);
    int* b = (int*)sys_malloc(520); 
    printf("malloc size of 520 at address %x.\n", b);
    sys_free(b);
    printf("free size of 520\n");
    printf("malloc size of 520 at address %x.\n", (int* )sys_malloc(520));
    printf("thread exit\n");
    //exit(0);
}
...
extern "C" void setup_kernel()
{
    ...
    systemService.setSystemCall(5, (int)sys_malloc);    
    systemService.setSystemCall(6, (int)sys_free);  
